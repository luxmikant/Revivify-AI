...
import { uploadFile, analyzeResume, type AnalysisResult } from "@/lib/api";
          ...
          <div className="space-y-6">
            <div className="text-center max-w-xl mx-auto">
              ...
              <p className="text-sm text-slate-400">
                ...
                pipeline will score ATS compatibility, uncover hidden strengths in
                your career gaps, and build a personalized bridge plan.
              </p>
            </div>
